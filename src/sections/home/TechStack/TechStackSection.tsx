...
const TechStackSection = () => {
  ...
  return (
    <section id="tech-stack" className="mx-auto container px-3">
      ...
      <motion.div
        ...
        className="bg-warm-gray-100 dark:bg-warm-gray-800 border border-warm-gray-400 dark:border-warm-gray-600 rounded-lg shadow-lg p-8 z-30"
      >
        ...
        <div className="flex justify-center mt-4">
          <div className="relative overflow-hidden max-w-sm group">
            ...
            <div className="flex animate-marquee w-fit gap-2 z-10 group-hover:pause">
            ...
            return (
              <Tooltip.Provider key={data.name} delayDuration={100}>
                <Tooltip.Root>
                  ...
                  <Tooltip.Portal>
                    <Tooltip.Content
                      className="bg-warm-gray-300 dark:bg-warm-gray-700 text-warm-gray-900 dark:text-warm-gray-50 px-2 py-1 rounded-lg shadow-md text-sm animate-slideUpAndFade"
                      sideOffset={5}
                      data-side="bottom"
                    >
                      {data.name}
